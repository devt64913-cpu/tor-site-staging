      ...
      <nav className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden xl:flex items-center gap-6">
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className={`flex items-center gap-1 px-2 py-2 text-sm font-medium transition-colors duration-200 relative group ${
                  isWhoWeAreActive 
                    ? "text-primary-500" 
                    : "text-gray-800 hover:text-primary-500"
                }`}
            ...
            <Link
              ...
              className={`ml-4 px-5 py-2 text-sm font-semibold rounded-lg transition-all duration-200 shadow-sm hover:shadow-md hover:scale-105 ${
          ...
          <div className="hidden lg:flex xl:hidden items-center gap-4">
            ...
            <Link
              href="/investor-contacts"
              className={`ml-2 px-5 py-2 text-sm font-semibold rounded-lg transition-all duration-200 shadow-sm hover:shadow-md hover:scale-105 ${
                pathname === "/investor-contacts"
                  ? "text-white bg-primary-600"
                  : "text-white bg-primary-500 hover:bg-primary-600"
              }`}
